...
Function Read-AppID {
    ...
    ElseIf ($global:AppID -eq 1247090) {
        New-LaunchScriptStormworksserverPS 
    }
    ElseIf ($global:AppID -eq 897590) {
        New-LaunchScriptMemoriesofMarsServerPS 
    }
    ElseIf ($global:AppID -eq 1110390) {
        New-LaunchScriptunturnedserverPS 
    }
    ElseIf ($global:AppID -eq 299310) {
        New-LaunchScriptSeriousSamserverPS 
    }
    ElseIf ($global:AppID -eq 748090) {
        New-LaunchScriptColonySurvivalServerPS 
    }
    ElseIf ($global:AppID -eq 1222650) {
