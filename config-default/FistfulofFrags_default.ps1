Function New-LaunchScriptFOFserverPS {
    ...
    $global:launchParams    = '@("${executable} -game fof -console -strictportbind -ip ${ip} -port ${port} +clientport ${clientport} +tv_port ${sourcetvport} +map ${defaultmap} +servercfgfile ${servercfg} -maxplayers ${maxplayers} -condebug")'
